...
$(function () {
  ...
  function gallery() {
    ...
    /*텍스트*/
    $('.bannerTxt .slideView2 div')
      .eq(n % 3)
      .stop()
      .animate({ bottom: '-100%' }, 'linear');
    $('.bannerTxt  .slideView2 div')
      .eq(m % 3)
      .css('bottom', '100%')
      .stop()
...
$(function () {
  $(window).scroll(function () {
    ...
    if (st > $bgchane01) {
      $(
        '#bgchane .scroll .item01 .page-img >div:nth-child(1) .imgLayer'
      ).animate(
        { height: '0' },
        {
          duration: 700,
      ...
      $('#bgchane .scroll .item01 .page-img >div:nth-child(1)').css({
        transform: 'scale(1)',
      });
    } else {
      $('#bgchane .scroll .item01 .page-img >div:nth-child(1)').css({
    ...
    if (st > $bgchane02) {
      $(
        '#bgchane .scroll .item02 .page-img >div:nth-child(1) .imgLayer'
      ).animate(
        { height: '0' },
        {
          duration: 700,
      ...
      $('#bgchane .scroll .item02 .page-img >div:nth-child(1)').css({
        transform: 'scale(1)',
      });
    } else {
      $('#bgchane .scroll .item02 .page-img >div:nth-child(1)').css({
    ...
    if (st > $bgchane03) {
      $(
        '#bgchane .scroll .item03 .page-img >div:nth-child(1) .imgLayer'
      ).animate(
        { height: '0' },
        {
          duration: 700,
      ...
      $('#bgchane .scroll .item03 .page-img >div:nth-child(1)').css({
        transform: 'scale(1)',
      });
    } else {
      $('#bgchane .scroll .item03 .page-img >div:nth-child(1)').css({
    ...
    if (st > $nextChallnge) {
      $('.centerImg').animate({ opacity: '1' }, 600);
    }
  });

  $('#new .inner>div .item .itemImg')
    .mouseover(function () {
...
$(function () {
  $(
    '.foot1Text>p, #lovi ul li, .item, .logo, .sns >div, .foo2right .footBtn, .foot2left ul li a, .left .nextText .nextLeftIcon img'
  )
    .mouseenter(function () {
      $('.circle').css({
        transform: 'scale(0.3)',
  ...
  $('#lovi .inner .loviEn')
    ...
    .mousemove(function (e) {
      ...
      $('.loviImg img')
        .eq(0)
        .addClass('on1')
        .css({ left: 300 - posX / 10, top: 800 - posY / 15, opacity: '1' }, 10);

      $('.loviImg img')
        .eq(1)
        .css(
          { left: 1000 - posX / 10, top: 550 - posY / 20, opacity: '1' },
          10
        );
      $('.loviImg img')
        .eq(2)
        .css({ left: 900 - posX / 10, top: 900 - posY / 20, opacity: '1' }, 10);
  ...
  $('#lovi .inner .loviEn')
    ...
    .mousemove(function (e) {
      ...
      $('.loviImg img')
        .eq(3)
        .addClass('on2')
        .css({ left: 500 - posX / 10, top: 800 - posY / 15, opacity: '1' }, 10);

      $('.loviImg img')
        .eq(4)
        .css({ left: 450 - posX / 10, top: 950 - posY / 20, opacity: '1' }, 10);
      $('.loviImg img')
        .eq(5)
        .css({ left: 500 - posX / 10, top: 500 - posY / 20, opacity: '1' }, 10);
  ...
  $('#lovi .inner .loviEn')
    ...
    .mousemove(function (e) {
      ...
      $('.loviImg img')
        .eq(9)
        .addClass('on3')
        .css({ left: 600 - posX / 10, top: 800 - posY / 20, opacity: '1' }, 10);
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            ...
            .addClass('on1_0')
            .css(
              { left: 200 - posX / 10, top: 800 - posY / 15, opacity: '1' },
              10
            );
          ...
          $('.loviImg img')
            .eq(1)
            .css(
              { left: 700 - posX / 10, top: 650 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(2)
            .css(
              { left: 600 - posX / 10, top: 900 - posY / 20, opacity: '1' },
              10
            );
          $('#lovi li.loviKo').eq(0).css({ opacity: '1' });
          $('#lovi').css({ background: 'rgba(230, 254, 255, 0.65)' });
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            ...
            .addClass('on2_0')
            .css(
              { left: 600 - posX / 10, top: 800 - posY / 15, opacity: '1' },
              10
            );
          ...
          $('.loviImg img')
            .eq(4)
            .css(
              { left: 350 - posX / 10, top: 950 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(5)
            .css(
              { left: 400 - posX / 10, top: 600 - posY / 20, opacity: '1' },
              10
            );
          $('#lovi li.loviKo').eq(1).css({ opacity: '1' });
          $('#lovi').css({ background: 'rgba(255, 232, 225, 0.67)' });
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            .eq(6)
            .css(
              { left: 350 - posX / 10, top: 900 - posY / 15, opacity: '1' },
              10
            );
          ...
          $('.loviImg img')
            .eq(7)
            .css(
              { left: 750 - posX / 10, top: 650 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(8)
            .css(
              { left: 650 - posX / 10, top: 900 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(9)
            .addClass('on3_0')
            .css(
              { left: 400 - posX / 10, top: 800 - posY / 20, opacity: '1' },
              10
            );
          $('#lovi li.loviKo').eq(2).css({ opacity: '1' });
          $('#lovi').css({ background: 'rgba(255, 254, 230, 0.69)' });
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            ...
            .addClass('on1_1')
            .css(
              { left: 100 - posX / 10, top: 800 - posY / 15, opacity: '1' },
              10
            );
          ...
          $('.loviImg img')
            .eq(1)
            .css(
              { left: 600 - posX / 10, top: 650 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(2)
            .css(
              { left: 500 - posX / 10, top: 900 - posY / 20, opacity: '1' },
              10
            );
          $('#lovi li.loviKo').eq(0).css({ opacity: '1' });
          $('#lovi').css({ background: 'rgba(230, 254, 255, 0.65)' });
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            ...
            .addClass('on2_1')
            .css(
              { left: 500 - posX / 10, top: 800 - posY / 15, opacity: '1' },
              10
            );
          ...
          $('.loviImg img')
            .eq(4)
            .css(
              { left: 250 - posX / 10, top: 950 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(5)
            .css(
              { left: 300 - posX / 10, top: 700 - posY / 20, opacity: '1' },
              10
            );
          $('#lovi li.loviKo').eq(1).css({ opacity: '1' });
          $('#lovi').css({ background: 'rgba(255, 232, 225, 0.67)' });
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            .eq(6)
            .css(
              { left: 200 - posX / 10, top: 900 - posY / 15, opacity: '1' },
              10
            );
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            .eq(1)
            .css(
              { left: 100 - posX / 10, top: 600 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(2)
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            ...
            .addClass('on2_1')
            .css(
              { left: 500 - posX / 10, top: 700 - posY / 15, opacity: '1' },
              10
            );
          ...
          $('.loviImg img')
            .eq(4)
            .css(
              { left: 150 - posX / 10, top: 850 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(5)
            .css(
              { left: 200 - posX / 10, top: 600 - posY / 20, opacity: '1' },
              10
            );
          $('#lovi li.loviKo').eq(1).css({ opacity: '1' });
          $('#lovi').css({ background: 'rgba(255, 232, 225, 0.67)' });
      ...
      $('#lovi .inner .loviEn')
        ...
        .mousemove(function (e) {
          ...
          $('.loviImg img')
            .eq(6)
            .css(
              { left: 100 - posX / 10, top: 700 - posY / 15, opacity: '1' },
              10
            );
          ...
          $('.loviImg img')
            .eq(7)
            .css(
              { left: 300 - posX / 10, top: 550 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(8)
            .css(
              { left: 200 - posX / 10, top: 800 - posY / 20, opacity: '1' },
              10
            );
          $('.loviImg img')
            .eq(9)
            .addClass('on3_1')
            .css(
              { left: 100 - posX / 10, top: 800 - posY / 20, opacity: '1' },
              10
            );
          $('#lovi li.loviKo').eq(2).css({ opacity: '1' });
          $('#lovi').css({ background: 'rgba(255, 254, 230, 0.69)' });
